...
<body>
    <div class="carouselwrap">
        <div class="carousel">
            <img src="img/header_tahograf.gif" alt="Tahograf srl" width="100%">
            <img src="img/tahoplace.jpg" alt="Tahograf srl" width="100%" style="position:absolute;">
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-4 p-2">
                <div class="card"><a href="tahografe.php">
                    ...
                    <div class="describe">
                        <p><br>Ofera tahografe si consumabile pentru toate tipurile de tahografe.
